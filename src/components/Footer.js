    ...
    <footer className="py-8 mt-10">
      <div className="max-w-6xl px-4 mx-auto">
        <div className="flex flex-col items-start justify-between md:flex-row-reverse">
          {/* Left Section */}
          <div
            class="flex flex-col items-center justify-center w-full p-4 mb-6 md:w-[57%]"
            bis_skin_checked="1"
          >
            <h3 class="text-2xl sm:text-3l">Download the Scanner App</h3>
            <div
              class="flex items-center justify-center space-x-6 my-10"
              bis_skin_checked="1"
            >
              <figure class="text-left">
                <a
                  href=" https://play.google.com/store/apps/details?id=zw.co.tango.tango_scanner "
                  target="_blank"
                  rel="noopener"
                >
                  <img
                    ...
                    alt="Play Store"
                    class="w-32 h-auto border-2 border-transparent hover:border-gray-500"
                  />
                </a>
              </figure>
              <figure class="text-left">
                <a
                  href=" https://apps.apple.com/app/tango-scanner/id6504612143"
                  target="_blank"
                  rel="noopener"
                >
                  <img
        ...
        <div className="pt-8 border-t border-gray-200">
          <div className="flex flex-col items-center justify-between sm:flex-row">
            ...
            <a
              href="docs.google.com/document/d/e/2PACX-1vTJGKgeHaKgtliZDbiQ3sSB0P4fllcmZYzZJhBmhTj5FI-eZiKtkPebu2gWp7BeNLPxAg6BmvqOX1q-/pub"
              className="text-sm text-gray-600 hover:text-[#147481] transition-colors duration-300"
            >
              Privacy Policy
            </a>
            <a
